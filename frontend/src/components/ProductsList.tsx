        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Общее количество отзывов и соотношение тональностей
            </p>
          </div>
        </div>
      </div>
      ...
      {filteredProducts.length > 4 && (
        <div className="px-6 py-3 border-t border-gray-200 flex-shrink-0 bg-gray-50">
          <div className="text-xs text-gray-500 text-center">
            📊 Все продукты • прокрутите для просмотра всех • нажмите на одну или несколько категорий для просмотра статистики
          </div>
        </div>
      )}
    </div>
